...
namespace YyWsnDeviceLibrary
{
    public class AO2 : Sensor
    {
        ...
        /// 滤波后的O2浓度，单位：ppm
        /// </summary>
        public UInt32 O2 { get; set; }

        /// <summary>
        /// 滤波前的O2浓度，单位：ppm
        /// </summary>
        public UInt32 uO2 { get; set; }
        ...
        public Int16 ReadSensorDataV3(byte[] SrcData, UInt16 IndexOfStart, bool ExistRssi)
        {
            ...
            O2 = (UInt32)(SrcData[IndexOfStart + 34] * 256 * 256 + SrcData[IndexOfStart + 35] * 256  + SrcData[IndexOfStart + 36]);
            uO2 = (UInt32)(SrcData[IndexOfStart + 38] * 256 * 256 + SrcData[IndexOfStart + 39] * 256 + SrcData[IndexOfStart + 40]); 
